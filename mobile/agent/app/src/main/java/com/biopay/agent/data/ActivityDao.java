 ...
 * string, so no date parsing is needed.
 */
public class ActivityDao {
    ...
    public List<Event> listAll() {
        ...
        try (Cursor c = db.query("vouchers", new String[]{"household_number", "amount", "created_at", "redemption_sync_status"},
                "status='REDEEMED'", null, null, null, null)) {
            while (c.moveToNext()) {
