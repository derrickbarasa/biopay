...
public class BiometricsProvider extends ContentProvider {
    ...
    private static final int NOMINEE = 1015;
    ...
    static {
        ...
        sUriMatcher.addURI(BiometricsContract.CONTENT_AUTHORITY, BiometricsContract.PATH_NOMINEE, NOMINEE);
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case NOMINEE:
                cursor = db.query(
                        BiometricsContract.NomineeEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (match) {
            ...
            case HOUSEHOLD:
                ...
                break;
            case NOMINEE:
                id = db.insertWithOnConflict(BiometricsContract.NomineeEntry.TABLE_NAME, null, values, SQLiteDatabase.CONFLICT_IGNORE);

                returnUri = ContentUris.withAppendedId(BiometricsContract.NomineeEntry.CONTENT_URI, id);
