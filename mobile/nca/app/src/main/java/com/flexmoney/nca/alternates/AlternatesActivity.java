...
public class AlternatesActivity extends AppCompatActivity {
    ...
    AutoCompleteTextView actvAlternateRelationship;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actvAlternateRelationship = findViewById(R.id.actvAlternateRelationship);
    ...
    private void setUpAdapters() {
        ...
        adapterRelationship = new ArrayAdapter<String>(this,android.R.layout.select_dialog_item,relationship);
        actvAlternateRelationship.setThreshold(1);
        actvAlternateRelationship.setAdapter(adapterRelationship);
        ...
        try {
            ...
            if (cursor.getCount() != 0) // data exist
            {
                if (cursor.moveToFirst()) {
                    ...
                    actvAlternateRelationship.setSelection(adapterRelationship.getPosition(altRelationship));
    ...
    private void validate() {
        if (!globalApplication.isNullOrEmpty(globalApplication.getHouseholdNumber())) {
            ...
            if (validateInputFields()) {
                if (globalApplication.isAutoCompleteTextViewSelected(actvAlternateRelationship, "Select the Alternate Relationship")) {
    ...
    private void store() {
        ...
        String altRelationship = actvAlternateRelationship.getText().toString().trim();
        if (altRelationship.contains("Daughter") && gender.equals("Male")) {
            ...
            if (!globalApplication.isNullOrEmpty(imageByte)) {
                ...
                value.put(BiometricsContract.AlternateEntry.COLUMN_NAME_RELATIONSHIP, actvAlternateRelationship.getText().toString().trim());
    ...
    private void update() {
        ...
        if (altRelationship.contains("Daughter") && gender.equals("Male")) {
            ...
            if (!globalApplication.isNullOrEmpty(imageByte)) {
                ...
                valueUpdate.put(BiometricsContract.AlternateEntry.COLUMN_NAME_RELATIONSHIP, actvAlternateRelationship.getText().toString().trim());
