package com.flexmoney.nca.login;
    ...
    private void storeFingerprint(int benType, String benNumbers) {
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                int percentCountHouseholds = 0;
                if (countHouseholds != 0) {
                    percentCountHouseholds = countHouseholds * 100 / maxHouseholds;
                }
                ...
                int percentCountAlternates = 0;
                if (countAlternates != 0) {
                    percentCountAlternates = countAlternates * 100 / maxAlternates;
                }
        ...
        System.out.println("http://15.236.31.134:50232/snsop/api/v1/fetch_fps_batch");
        StringRequest str = new StringRequest(Request.Method.POST, "http://15.236.31.134:50232/snsop/api/v1/fetch_fps_batch",
