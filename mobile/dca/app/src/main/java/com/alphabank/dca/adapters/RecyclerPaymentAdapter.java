...
public class RecyclerPaymentAdapter extends RecyclerView.Adapter<RecyclerPaymentAdapter.BeneficiaryHolder> {
    ...
    public RecyclerPaymentAdapter(Context context, List<Payment> beneficiaryList) {
