package com.alphabank.dca.sync;
...
import com.alphabank.dca.AccountGeneral;
...
import com.alphabank.dca.objects.VolleyMultipartRequest;
...
public class BiometricsSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String SYNC_COMPLETE_INTENT = "com.alphabank.dca.intent.action.SYNC_COMPLETE";
                ...
                if (getHouseholdRows != 0) {
                    if (cursor.moveToFirst()) {
                        do {
                            ...
                            map.put(BiometricsContract.HouseholdEntry.COLUMN_NAME_INCOME_HOUSEHOLD, cursor.getString(cursor.getColumnIndex(BiometricsContract.HouseholdEntry.COLUMN_NAME_INCOME_HOUSEHOLD)));
                            ...
                            map.put(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_ZERO_FIVE, cursor.getString(cursor.getColumnIndex(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_ZERO_FIVE)));
                            map.put(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_SIX_EIGHTEEN, cursor.getString(cursor.getColumnIndex(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_SIX_EIGHTEEN)));
                            map.put(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_NINETEEN_FORTY_FIVE, cursor.getString(cursor.getColumnIndex(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_NINETEEN_FORTY_FIVE)));
                            map.put(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_FORTY_SIX_SIXTY_FIVE, cursor.getString(cursor.getColumnIndex(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_FORTY_SIX_SIXTY_FIVE)));
                            map.put(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_SIXTY_SIX, cursor.getString(cursor.getColumnIndex(BiometricsContract.HouseholdEntry.COLUMN_NAME_DEPENDANTS_SIXTY_SIX)));
                            ...
                            System.out.println("url: " + "http://173.249.55.90:15000/dca/api/v1/households");

                            StringRequest str = new StringRequest(
                                    Request.Method.POST,
                                    "http://173.249.55.90:15000/dca/api/v1/households",
            ...
            try {
                ...
                if (cursor.getCount() != 0) {
                    if (cursor.moveToFirst()) {
                        ...
                        System.out.println("url: " + "http://173.249.55.90:15000/dca/api/v1/alternates");
                        StringRequest altStr = new StringRequest(Request.Method.POST, "http://173.249.55.90:15000/dca/api/v1/alternates",
                                new Response.Listener<String>() {
                                    @Override
                                    public void onResponse(String response) {
    ...
    private void sendAttendance() {
        ...
        while (rowAttendance == true) {
            ...
            if (attendanceArray.size() != 0) {
                ...
                System.out.println("http://173.249.55.90:15000/dca/api/v1/attendance");
                StringRequest strAtt = new StringRequest(Request.Method.POST, "http://173.249.55.90:15000/dca/api/v1/attendance",
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
    ...
    private void sendPayments() {
        ...
        while (rowPayments == true) {
            ...
            if (paymentArray.size() != 0) {
                ...
                StringRequest str = new StringRequest(Request.Method.POST, "http://173.249.55.90:15000/dca/api/v1/paid",
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
                ...
                if (getFingerprintRows != 0) {
                    if (cursor.moveToFirst()) {
                        do {
                            ...
                            System.out.println("url: " + "http://173.249.55.90:15000/dca/api/v1/fingerprints");
                            StringRequest str = new StringRequest(
                                    Request.Method.POST,
                                    "http://173.249.55.90:15000/dca/api/v1/fingerprints",
                                    new Response.Listener<String>() {
                                        @Override
                                        public void onResponse(String response) {
            ...
            try {
                ...
                if (cursor.getCount() != 0) {
                    if (cursor.moveToFirst()) {
                        ...
                        System.out.println("url: " + "http://173.249.55.90:15000/dca/api/v1/images");
                        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, "http://173.249.55.90:15000/dca/api/v1/images",
