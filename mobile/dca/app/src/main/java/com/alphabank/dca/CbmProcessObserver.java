...
public class CbmProcessObserver implements Observer {
    ...
    public CbmProcessObserver(View rootView, Context context) {
        this.rootView = rootView;
        if(context.getClass().getSimpleName().trim().equals("FingerprintsActivity")) {
            currentCaptureBitmapId = R.id.ivHouseholdFingerprint;
        }else if(context.getClass().getSimpleName().trim().equals("AlternateFingerprintsActivity")){
            currentCaptureBitmapId = R.id.ivAlternateFingerprint;
        }else if(context.getClass().getSimpleName().trim().equals("PaymentVerificationActivity")){
            currentCaptureBitmapId = R.id.ivPaymentVerification;
        }else{
            currentCaptureBitmapId = R.id.ivHouseholdFingerprint;
        }
    }
