...
import com.alphabank.dca.data.BiometricsContract.AlternateEntry;
import com.alphabank.dca.data.BiometricsContract.AssignmentsEntry;
import com.alphabank.dca.data.BiometricsContract.AttendanceEntry;
import com.alphabank.dca.data.BiometricsContract.BomasEntry;
import com.alphabank.dca.data.BiometricsContract.CountiesEntry;
import com.alphabank.dca.data.BiometricsContract.HouseholdEntry;
import com.alphabank.dca.data.BiometricsContract.PayamsEntry;
import com.alphabank.dca.data.BiometricsContract.PaymentsEntry;
import com.alphabank.dca.data.BiometricsContract.PermissionsEntry;
import com.alphabank.dca.data.BiometricsContract.RegionsEntry;
import com.alphabank.dca.data.BiometricsContract.StatesEntry;
import com.alphabank.dca.data.BiometricsContract.SupervisorsEntry;
import com.alphabank.dca.data.BiometricsContract.ImageEntry;
import com.alphabank.dca.data.BiometricsContract.FingerprintEntry;

public class DatabaseHelper extends SQLiteOpenHelper {
    //database name
    public static final String DB_NAME = "dca.db";
    //database version
    ...
    private static final String TB_HOUSEHOLD = "CREATE TABLE " + HouseholdEntry.TABLE_NAME + " ( " +
            ...
            HouseholdEntry.COLUMN_NAME_DEPENDANTS_ZERO_FIVE + " VARCHAR," +
            HouseholdEntry.COLUMN_NAME_DEPENDANTS_SIX_EIGHTEEN + " VARCHAR," +
            HouseholdEntry.COLUMN_NAME_DEPENDANTS_NINETEEN_FORTY_FIVE + " VARCHAR," +
            HouseholdEntry.COLUMN_NAME_DEPENDANTS_FORTY_SIX_SIXTY_FIVE + " VARCHAR," +
            HouseholdEntry.COLUMN_NAME_DEPENDANTS_SIXTY_SIX + " VARCHAR," +
            HouseholdEntry.COLUMN_NAME_INCOME_HOUSEHOLD + " VARCHAR," +
    ...
    public Cursor getUnpaidPayments() {
        ...
        try {
            ...
            String sql = "SELECT household_number,household_name FROM households WHERE household_number " +
                    "NOT IN(SELECT household_number FROM payments) "+
                    "ORDER BY household_number DESC";
