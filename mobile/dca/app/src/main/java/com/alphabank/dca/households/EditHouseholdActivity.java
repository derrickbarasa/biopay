...
import com.alphabank.dca.adapters.RecyclerBeneficiaryAdapter;
import com.alphabank.dca.data.BiometricsContract;
import com.alphabank.dca.objects.Beneficiary;
...
public class EditHouseholdActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(EditHouseholdActivity.this, LocationActivity.class));
    }
