...
.overline { color: #059669; font-size: .72rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; margin-bottom: 6px; }
...
.metric-grid :deep(.v-card)::after { content: ''; position: absolute; width: 92px; height: 92px; right: -38px; bottom: -42px; border-radius: 50%; background: rgba(20, 184, 166, .12); }
.metric-grid :deep(.text-h4), .metric-grid :deep(.text-h5) { color: #064e3b; margin-top: 9px; letter-spacing: -.035em; }
