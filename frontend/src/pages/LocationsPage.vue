...
// Codes are generated by the backend; state is the top-level geography, so there's no country field.
...
// anchor A can never be picked as the parent of a County created under anchor B.
...
// The backend generates every code, so a row only ever needs a name.
