...
export const PERMISSION_GROUPS: PermissionGroupDefinition[] = [
  ...
  },
  {
    ...
    permissions: ['ACCESS_HOUSEHOLDS', 'ACCESS_ALTERNATES', 'ACCESS_PAYMENTS', 'PAY_ONLINE', 'ACCESS_PAYMENT_CYCLES', 'CHECK_PAYMENT_CYCLES', 'ACCESS_VOUCHERS', 'ACCESS_ATTENDANCE'],
  },
  {
