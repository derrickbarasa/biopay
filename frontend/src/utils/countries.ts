/** World country list with ISO-3166-1 alpha-2 code and capital city, used
 *  wherever a form should auto-fill a capital from a chosen country (organisation
 *  registration, anchor address) and wherever a location code needs a country
 *  abbreviation prefix (e.g. Kenya -> KE, Uganda -> UG). */
...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Congo (Republic of the)', code: 'CG', capital: 'Brazzaville' },
  ...
  { name: 'Democratic Republic of the Congo', code: 'CD', capital: 'Kinshasa' },
  ...
  { name: 'Iceland', code: 'IS', capital: 'Reykjavík' },
  ...
  { name: 'Ivory Coast', code: 'CI', capital: 'Yamoussoukro' },
  ...
  { name: 'Kiribati', code: 'KI', capital: 'South Tarawa' },
  ...
  { name: 'Myanmar', code: 'MM', capital: 'Naypyidaw' },
  ...
  { name: 'North Macedonia', code: 'MK', capital: 'Skopje' },
  ...
  { name: 'Palestine', code: 'PS', capital: 'Ramallah' },
  ...
  { name: 'Sao Tome and Principe', code: 'ST', capital: 'São Tomé' },
  ...
  { name: 'Vatican City', code: 'VA', capital: 'Vatican City' },
