...
- **Still open:** verifications UI audit; deduplication (needs match-key decision); subscription (needs billing decision); mobile face-recognition (needs SDK decision); website landing redesign (frontend); datatables search polish. Local commits: `0fba6fb`, `721862e`, `72b42dc`, `55b5485`, `1056b96`, + this one — all unpushed (GitHub read-only).
