...
public final class PermissionPolicy {
    private static final Map<String, String> REQUIRED = Map.ofEntries(
            ...
            Map.entry("TOGGLE_GEO_NODE_STATUS", "ACCESS_LOCATIONS"),
            ...
            Map.entry("BULK_SET_HOUSEHOLD_REVIEW_STATUS", "ACCESS_HOUSEHOLDS"),
            Map.entry("DEACTIVATE_HOUSEHOLD", "ACCESS_HOUSEHOLDS"), Map.entry("ACTIVATE_HOUSEHOLD", "ACCESS_HOUSEHOLDS"),
            ...
            Map.entry("ACTIVATE_ALTERNATE", "ACCESS_ALTERNATES"),
